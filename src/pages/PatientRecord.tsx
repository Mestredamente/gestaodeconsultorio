  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in pb-10">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight text-slate-900 line-clamp-1">
            {patient?.nome}
          </h1>
        ...
        <CardContent className="p-4 md:p-6 space-y-4">
          <div className="space-y-2">
            <Label className="text-base font-bold flex items-center gap-2 text-slate-800">
              <AlertCircle className="w-4 h-4 text-amber-500" /> Queixa Principal / Hipótese
              Diagnóstica
            </Label>
            <Textarea
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-end">
              <Button
                ...
                className="rounded-xl px-6 w-full sm:w-auto h-11"
              >
                {saving ? (
      ...
      <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 before:to-transparent">
        {record?.historico_sessoes?.length === 0 ? (
          <div className="text-center py-10 text-slate-400 font-medium relative z-10 bg-slate-50 rounded-2xl mx-12">
            ...
            >
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 md:p-6 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition-shadow ml-4 md:ml-0">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 mb-3">
                  ...
                  <time className="text-xs font-medium text-slate-500 bg-slate-100 px-2 py-1 rounded-md self-start sm:self-auto">

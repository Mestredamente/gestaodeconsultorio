          ...
          <div className="md:col-span-2 space-y-6">
            <Card className="shadow-sm border-slate-200">
              ...
              <CardContent className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 text-sm">
                ...
                <div>
                  <span className="text-slate-500 font-medium block mb-1">Data de Nascimento</span>
              ...
              <TabsContent value="portal" className="mt-4">
                <Card className="border-indigo-100 shadow-sm bg-indigo-50/30">
                  <CardContent className="p-6 text-center space-y-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-indigo-900">Portal do Paciente</h3>
              ...
              <CardContent className="p-5 space-y-4 text-sm">
                ...
                {patient.dia_pagamento && (
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-slate-900">Dia {patient.dia_pagamento}</span>
                  </div>
                )}
              </CardContent>
            </Card>

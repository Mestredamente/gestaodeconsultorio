...
BEGIN
  ...
  IF v_user_id IS NULL THEN
    ...
    INSERT INTO auth.users (
      ...
      '{"name": "Admin", "nome_consultorio": "Consultório Central"}'::jsonb,
  ...
  VALUES (v_user_id, 'admin@example.com', 'admin', 'Consultório Central')
  ON CONFLICT (id) DO UPDATE SET 
    email = EXCLUDED.email,
    role = EXCLUDED.role,
    nome_consultorio = COALESCE(public.usuarios.nome_consultorio, 'Consultório Central');
